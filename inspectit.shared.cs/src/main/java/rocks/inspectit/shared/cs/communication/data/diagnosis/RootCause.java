...
public class RootCause {
	 ...
	 *            List of all invocations to the method.
	 */
	public RootCause(final long methodIdent, final InvocationSequenceData invocationSequenceData, final List<InvocationSequenceData> invocationSequenceDataList) {
		this.methodIdent = methodIdent;
		this.timerDataProblemOccurence = new TimerDataProblemOccurence(invocationSequenceData);
		for (InvocationSequenceData invocationSequenceDataItem : invocationSequenceDataList) {
			this.timerDataOfMethodInvocations.add(new TimerDataProblemOccurence(invocationSequenceDataItem));
		}
	}
