...
public class DiagnosisCmrProcessor extends AbstractCmrDataProcessor implements IDiagnosisResultNotificationService {
	...
	// /**
	// * Prints a problemOccurrenceObject
	// *
	...
	// System.out.println("------------------");
	// System.out.println("+ " +
	// CachedDataMapper.getInstance().getBusinessTransactionName(
	// problemOccurrence.getBusinessTransactionNameIdent(),
	...
	// System.out.println("+ " + CachedDataMapper.getInstance()
	// .getFQMethodeName(problemOccurrence.getGlobalContext().getMethodIdent()));
	// System.out
	// .println("+ " +
	// problemOccurrence.getGlobalContext().getTimerDataProblemOccurence().getExclusiveTime());
	// System.out.println("+ " + CachedDataMapper.getInstance()
	// .getFQMethodeName(problemOccurrence.getProblemContext().getMethodIdent()));
	// System.out.println(
	// "+ " +
	...
	// problemOccurrence.getRootCause()
	// .getTimerDataPerMethod();
	// for (long key : rootCauseMapping.keySet()) {
	// System.out.print("++ " +
	// CachedDataMapper.getInstance().getFQMethodeName(key));
	// ArrayList<TimerDataProblemOccurence> rootCauseList =
	// rootCauseMapping.get(key);
	//
	// double sum = 0;
	//
	...
	//
	// System.out.println(
	// " Average " + ((sum / rootCauseList.size()) + " Size " +
